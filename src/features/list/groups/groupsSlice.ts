    ...
    extraReducers: (builder) => {
        ...
        builder.addCase(updateItem, (state, action) => {
            ...
            removableTags.forEach((t: string) => {
                ...
                updatableGroups.push({id: gr.title, changes: {tags: [...gr.tags.filter((tg: string) => tg !== t)]}});
            });
...
export const { updateGroup, updateManyGroups, addGroup, removeGroup } = slice.actions;
